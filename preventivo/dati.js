...
luoghi: [
  /* --- TOKYO ------------------------------------------------------------ */
  { id:"ramen",      citta:"tokyo", nome:"Il giro dei ramen: la fila alle undici davanti a un bancone", tag:["cibo","cibo_ramen","insolito"], ore:1.5, yen:1400, nota:"I posti migliori hanno il distributore di biglietti all'ingresso e dieci sgabelli.", tipo:"spesa"},
  { id:"kissaten",   citta:"tokyo", nome:"Kissaten a Jinbocho: caffè, fumo e librerie", tag:["cibo","cibo_dolci","tradizione","ins_quartieri"], ore:2, yen:1500, tipo:"spesa"},
  { id:"kaiseki",    citta:"tokyo", nome:"Una cena kaiseki", tag:["cibo","cibo_alta","tradizione"], ore:3, yen:18000, nota:"Si prenota settimane prima e spesso serve che lo faccia l'hotel.", c:"S", tipo:"spesa"},
  ...
  { id:"nezu",       citta:"tokyo", nome:"Museo Nezu e il suo giardino", tag:["arte","arte_classica","museo_arte","nat_giardini","templi_giardino"], ore:2.5, yen:1600, c:"V", fonte:"nezu-muse.or.jp/jp/visit/", verificato:"2026-08-23"},
  { id:"takao",      citta:"tokyo", nome:"Monte Takao: la montagna dentro Tokyo", tag:["hiking","hike_medio","natura","nat_montagna","templi_nascosti","pano_fuji"], ore:6, yen:980, c:"V", fonte:"takaotozan.co.jp", verificato:"2026-08-23"},
  { id:"karaokebox", citta:"tokyo", nome:"Karaoke in stanza privata fino a tardi", tag:["notturno","notte_karaoke","kids"], ore:2.5, yen:2500, tipo:"spesa"},
  { id:"teatokyo",   citta:"tokyo", nome:"Cerimonia del tè con un maestro", tag:["tradizione","trad_te","insolito"], ore:2, yen:4500, c:"S", tipo:"spesa"},
  { id:"kimonotokyo",citta:"tokyo", nome:"Kimono per la giornata ad Asakusa", tag:["tradizione","trad_kimono","shopping","kids"], ore:1, yen:4500, c:"S", tipo:"spesa"},
  { id:"itoya",      citta:"tokyo", nome:"Itoya a Ginza: nove piani di sola cartoleria", tag:["shopping","shop_carta","insolito"], ore:1.5, yen:2000, tipo:"spesa"},
  ...
  { id:"miraikan",   citta:"tokyo", nome:"Miraikan: robot, spazio, cose da premere", tag:["musei","museo_tecnica","kids","kids_interattivo"], ore:3, yen:630, c:"V", fonte:"miraikan.jst.go.jp", verificato:"2026-08-23"},
  ...
  { id:"kabukiza",   citta:"tokyo", nome:"Kabuki-za: un atto solo, dal loggione", tag:["tradizione","trad_spettacolo","storia"], ore:2, yen:2000, nota:"Il biglietto per un atto si compra il giorno stesso e costa un decimo.", c:"V", fonte:"kabuki-bito.jp", verificato:"2026-08-23"},
  { id:"puroland",   citta:"tokyo", nome:"Sanrio Puroland", tag:["kids","kids_parchi","anime","action"], ore:6, yen:4600, c:"V", fonte:"puroland.jp/passport/", verificato:"2026-08-23"},
  { id:"sumida",     citta:"tokyo", nome:"Acquario Sumida, sotto la Skytree", tag:["kids","kids_animali","musei","mare"], ore:2.5, yen:2050, c:"V", fonte:"sumida-aquarium.com", verificato:"2026-08-23"},
  { id:"uenozoo",    citta:"tokyo", nome:"Zoo di Ueno", tag:["kids","kids_animali","natura"], ore:3, yen:600, c:"V", fonte:"tokyo-zoo.net/zoo/ueno/", verificato:"2026-08-23"},
  ...
  { id:"gashapon",   citta:"tokyo", nome:"Gashapon no Depato a Ikebukuro (migliaia di macchinette)", tag:["action","anime","insolito","fig_gasha","kids"], ore:1.5, yen:2000, nota:"Porta monete da 100 yen: le macchinette non danno resto.", tipo:"spesa"},
  ...
  { id:"pokecenter", citta:"tokyo", nome:"Pokémon Center e Nintendo Tokyo a Shibuya", tag:["action","retrogaming","kids","shopping","fig_nuovo","game_nintendo"], ore:1.5, yen:3000, tipo:"spesa"},
  ...
  { id:"akihabara",  citta:"tokyo", nome:"Akihabara: elettronica, gachapon, maid cafe", tag:["anime","retrogaming","shopping","action","fig_nuovo","fig_usato","game_arcade"], ore:4, yen:2000, tipo:"spesa"},
  ...
  { id:"superpotato",citta:"tokyo", nome:"Super Potato, tempio del retrogaming", tag:["retrogaming","anime","shopping","game_usato","game_arcade"], ore:1.5, yen:1500, tipo:"spesa"},
  { id:"teamlab",    citta:"tokyo", nome:"teamLab (arte digitale immersiva)", tag:["arte","musei","insolito","arte_contemp","kids_interattivo","museo_arte"], ore:3, yen:3800, c:"V", fonte:"teamlab.art", verificato:"2026-08-23"},
  { id:"skytree",    citta:"tokyo", nome:"Tokyo Skytree", tag:["panorama","kids","pano_alto","pano_notte","kids_interattivo"], ore:2, yen:2100, c:"S", fonte:"tokyo-skytree.jp/ticket/", fascia_prezzo:"va da 1.800 (deck, anticipato) a 3.000 (deck+corridoio)"},
  { id:"meiji",      citta:"tokyo", nome:"Meiji Jingu e Harajuku", tag:["templi","natura","gratis","shopping","templi_top","nat_giardini"], ore:3, yen:0 },
  { id:"ghiblimus",  citta:"tokyo", nome:"Museo Ghibli a Mitaka", tag:["anime","musei","kids","museo_anime","kids_interattivo"], ore:3, yen:1000, anime:"ghibli", nota:"Biglietti a estrazione, si comprano il 10 del mese precedente.", c:"V", fonte:"ghibli-museum.jp/ticket/", verificato:"2026-08-23"},
  { id:"goldengai",  citta:"tokyo", nome:"Golden Gai e Omoide Yokocho di notte", tag:["notturno","cibo","insolito","notte_vicoli","notte_bar","cibo_izakaya"], ore:3, yen:4000, tipo:"spesa"},
  { id:"tsukiji",    citta:"tokyo", nome:"Mercato esterno di Tsukiji", tag:["cibo","tradizione","cibo_street","cibo_sushi","shop_artigiano"], ore:2.5, yen:2500, tipo:"spesa"},
  { id:"toyosu",     citta:"tokyo", nome:"Asta del tonno a Toyosu (alba)", tag:["cibo","insolito","cibo_sushi","ins_esperienze"], ore:3, yen:0, nota:"Sveglia alle 4. Ne vale la pena una volta nella vita.", tipo:"spesa"},
  ...
  { id:"doraemon",   citta:"tokyo", nome:"Museo Fujiko F. Fujio (Doraemon), Kawasaki", tag:["anime","musei","kids","museo_anime","kids_interattivo"], ore:3, yen:1000, anime:"doraemon", c:"V", fonte:"fujiko-museum.com/ticket/", verificato:"2026-08-23"},
  { id:"ueno",       citta:"tokyo", nome:"Parco di Ueno e Museo Nazionale", tag:["musei","storia","sakura","museo_storia","museo_arte","nat_fiori"], ore:3.5, yen:1000, top:[3,4], c:"V", fonte:"tnm.jp", verificato:"2026-08-23"},
  { id:"sumo",       citta:"tokyo", nome:"Torneo di sumo al Ryogoku Kokugikan", tag:["tradizione","insolito","trad_spettacolo","ins_esperienze"], ore:4, yen:3100, solo:[1,5,9], c:"V", fonte:"sumo.or.jp", verificato:"2026-08-23"},
  ...
  { id:"nishiki",    citta:"kyoto", nome:"Mercato di Nishiki", tag:["cibo","tradizione","cibo_street"], ore:2, yen:2500, tipo:"spesa"},
  { id:"tea",        citta:"kyoto", nome:"Cerimonia del tè con maestro", tag:["tradizione","insolito","trad_te"], ore:2, yen:4500, c:"S", tipo:"spesa"},
  { id:"kimono",     citta:"kyoto", nome:"Noleggio kimono per la giornata", tag:["tradizione","shopping","kids","trad_kimono"], ore:1, yen:5000, c:"S", tipo:"spesa"},
  ...
  /* --- OSAKA ------------------------------------------------------------ */
  { id:"dotonbori",  citta:"osaka", nome:"Dotonbori e il Glico Man", tag:["notturno","cibo","gratis","cibo_street","notte_luci"], ore:3, yen:2500, tipo:"spesa"},
  { id:"osakajo",    citta:"osaka", nome:"Castello di Osaka", tag:["storia","sakura","storia_castelli"], ore:2.5, yen:600, top:[4], c:"S" },
  { id:"kuromon",    citta:"osaka", nome:"Mercato Kuromon", tag:["cibo","cibo_street"], ore:2, yen:3000, tipo:"spesa"},
  { id:"shinsekai",  citta:"osaka", nome:"Shinsekai e kushikatsu", tag:["cibo","insolito","notturno"], ore:3, yen:3000, tipo:"spesa"},
  ...
  /* --- HAKONE / FUJI ---------------------------------------------------- */
  { id:"owakudani",  citta:"hakone",nome:"Owakudani e la funivia sulle solfatare", tag:["natura","panorama","nat_montagna","pano_alto"], ore:3, yen:2000, c:"V", fonte:"hakoneropeway.co.jp", verificato:"2026-08-23"},
  { id:"hakoneopen", citta:"hakone",nome:"Hakone Open Air Museum", tag:["arte","musei","natura","arte_contemp","museo_arte"], ore:2.5, yen:2000, c:"V", fonte:"hakone-oam.or.jp", verificato:"2026-08-23"},
  { id:"onsenhakone",citta:"hakone",nome:"Onsen con vista (day use)", tag:["onsen","natura","onsen_day","onsen_tattoo"], ore:2.5, yen:2000, c:"S", tipo:"spesa"},
  { id:"eva",        citta:"hakone",nome:"Hakone = Tokyo-3: i luoghi di Evangelion", tag:["anime","gratis","panorama"], ore:3, yen:0, anime:"eva" },
  { id:"ashi",       citta:"hakone",nome:"Lago Ashi e il torii sull'acqua", tag:["panorama","natura","nat_montagna","pano_fuji"], ore:2, yen:1200, c:"V", fonte:"hakone-kankosen.co.jp", verificato:"2026-08-23"},
  ...
  { id:"kawaguchi",  citta:"fuji",  nome:"Giro del lago Kawaguchi in bici", tag:["natura","panorama","nat_montagna","pano_fuji","hike_facile"], ore:4, yen:1500, tipo:"spesa"},
  { id:"yurucamp",   citta:"fuji",  nome:"I campeggi di Yuru Camp", tag:["anime","natura","hiking","hike_facile","nat_montagna"], ore:4, yen:1000, anime:"yurucamp", tipo:"spesa"},
  { id:"fujisan",    citta:"fuji",  nome:"Salita al monte Fuji (notte in rifugio)", tag:["hiking","natura","insolito","hike_duro","pano_alto"], ore:14, yen:12000, solo:[7,8,9], c:"S", fonte:"fujisan-climb.jp", fascia_prezzo:"dipende dal rifugio: 10.000-15.500 con mezza pensione"},
  ...
  { id:"omicho",     citta:"kanazawa",nome:"Mercato Omicho: granchio e ricci", tag:["cibo"], ore:1.5, yen:3500, tipo:"spesa"},
  { id:"takayamaold",citta:"takayama",nome:"Sanmachi, la città vecchia di Takayama", tag:["tradizione","gratis","cibo"], ore:3, yen:0 },
  { id:"hidabeef",   citta:"takayama",nome:"Manzo di Hida alla griglia", tag:["cibo","cibo_alta"], ore:1.5, yen:5000, c:"S", tipo:"spesa"},
  ...
  { id:"okonomi",    citta:"hiroshima",nome:"Okonomiyaki stile Hiroshima", tag:["cibo","cibo_street"], ore:1.5, yen:1500, tipo:"spesa"},
  ...
  /* --- KYUSHU ----------------------------------------------------------- */
  { id:"yatai",      citta:"fukuoka",nome:"Yatai: cena nei chioschi lungo il fiume", tag:["cibo","notturno","insolito","cibo_street","notte_vicoli"], ore:2.5, yen:3500, tipo:"spesa"},
  ...
  { id:"gyutan",     citta:"sendai",nome:"Gyutan, lingua di manzo alla griglia", tag:["cibo","cibo_alta"], ore:1.5, yen:2200, tipo:"spesa"},
  ...
  { id:"shibazakura",citta:"chichibu",nome:"Tappeto di shibazakura a Hitsujiyama", tag:["natura","sakura","panorama","nat_fiori","pano_alto"], ore:2, yen:500, solo:[4,5], c:"V", fonte:"city.chichibu.lg.jp", verificato:"2026-08-23"},
  ...
  { id:"daibutsu",   citta:"kamakura",nome:"Grande Buddha di Kamakura", tag:["templi","storia","templi_top","storia_edo"], ore:1.5, yen:300, c:"V", fonte:"kotoku-in.jp", verificato:"2026-08-23"},
  ...
  { id:"toshogu",    citta:"nikko", nome:"Toshogu e i cedri di Nikko", tag:["templi","storia","natura","foliage","templi_top","storia_edo","nat_giardini"], ore:4, yen:1600, top:[10,11], c:"V", fonte:"toshogu.jp", verificato:"2026-08-23"},
